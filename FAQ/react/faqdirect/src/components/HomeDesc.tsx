...
export const HomeDesc = (props: any) => {
  ...
  return (
    ...
    <TopicContent response={response} showDescription={true} />
    </div>
    ...
    <RelatedTopics reftopics={reftopics} onClickItem={onClickItem2} linkBase="/Content" />
    </div>
