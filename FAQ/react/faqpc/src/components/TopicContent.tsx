...
export const TopicContent = (props: any) => {
 ...
 useEffect(() => {
  ...
  return (
    ...
    <div style = {{ width: "100%",height: "10%",overflow: "auto",border: "solid #000000 1px"}}><span  className="fs-5 text-primary" style = {{ marginLeft: "20px", marginRight: "20px"}}><i className="bi bi-question-circle-fill text-info bg-white"></i> {response.Title}</span></div>
