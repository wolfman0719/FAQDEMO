  ...
  return (
    ...
    <table style={{ width: "100%" }}><tbody>
      {isLoading ? (<tr><td>Data Loading</td></tr>)
         ...
         <td><button className="btn-flat waves-effect" style={{ width: "100%", textAlign: "left", color: "#000000", textTransform: "none" }} onClick={() => onClickItem(topic.id)}>{`${topic.id}:${topic.title}`}</button></td>
         </tr>
         )))
      }
    </tbody></table>
